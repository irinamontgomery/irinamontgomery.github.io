...
// pass some parameter to make a guess function takeAGuess(guess)
function takeAGuess(guess) {
    ...
    if (regExGuess.test(theWord)) {
        ...
        for (var i = 0; i < wordLength; i++) {
            ...
            switch (guesses) {
                case 1:
                    $('.guy').attr('src', 'assets/images/1.png');
                    break;
                case 2:
                    $('.guy').attr('src', 'assets/images/2.png');
                    break;
                case 3:
                    $('.guy').attr('src', 'assets/images/3.png');
                    break;
                case 4:
                    $('.guy').attr('src', 'assets/images/4.png');
                    break;
                case 5:
                    $('.guy').attr('src', 'assets/images/5.png');
                    break;
                case 6:
                    $('.guy').attr('src', 'assets/images/6.png');
                    break;
                case 7:
                    $('.guy').attr('src', 'assets/images/7.png');
